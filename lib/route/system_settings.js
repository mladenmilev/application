...
router.post('/company/', function(req, res){
    ...
    if ( req.session.flash_has_errors() ) {
      return res.redirect_with_session('/system_settings/general/');
    }
...
router.post('/departments/', function(req, res){
    ...
    .then(function(){
        if ( req.session.flash_has_errors() ) {
            return res.redirect_with_session('/system_settings/departments/');
        } else {
...
router.post('/company/authentication/', function(req, res){
  ...
  req.user
    ...
    .then(function(){
      if ( req.session.flash_has_errors() ) {
        return res.redirect_with_session('/system_settings/company/authentication/');
      } else {
